...
export interface DefaultIpFormSection {
  ...
  title: string;
  description?: string;
  /** Surrogate-free copy variant used in IVF-only contexts (clinic form/PDF). */
  descriptionIvf?: string;
  perParent?: boolean;
  excludeFromSurrogatePdf?: boolean;
  ...
  return [
    ...
    },
    {
      ...
      questions: [
        ...
        { key: "clinic_none", label: "I don't have a fertility clinic yet", widget: "yes_no" },
        { key: "clinic_name", label: "Clinic Name", widget: "text", required: true },
        { key: "clinic_re_name", label: "Reproductive Endocrinologist Name", widget: "text", required: true },
        { key: "clinic_address", label: "Address", widget: "address", required: true },
        { key: "clinic_coordinator_name", label: "Coordinator Name", widget: "text", required: true },
        { key: "clinic_coordinator_email", label: "Coordinator Email", widget: "text", required: true, excludeFromSurrogatePdf: true },
        { key: "clinic_phone", label: "Phone Number", widget: "phone", required: true, excludeFromSurrogatePdf: true },
      ],
    },
    {
      key: "embryo",
      ...
      questions: [
        ...
        { key: "embryo_genetically_tested", label: "Have your embryos been genetically tested?", widget: "yes_no", required: true },
        { key: "embryo_storage_location", label: "Where are your embryos being stored?", widget: "text", required: true },
        { key: "embryo_used_egg_donor", label: "Did you use an egg donor?", widget: "yes_no", required: true },
        {
        ...
        { key: "embryo_used_sperm_donor", label: "Did you use a sperm donor?", widget: "yes_no", required: true },
        {
        ...
        { key: "embryo_transfer_count", label: "How many embryos do you plan to transfer?", widget: "number", required: true },
        {
        ...
        { key: "embryo_retry_transfer", label: "If the initial transfer is not successful, will you attempt another transfer?", widget: "yes_no", required: true },
        { key: "embryo_up_to_three", label: "Are you willing to transfer up to three times?", widget: "yes_no", required: true },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        { key: "personal_languages", label: "What languages do you speak?", widget: "text", required: true },
        { key: "personal_favorite_food", label: "What is your favorite food?", widget: "text", required: true },
        { key: "personal_religion", label: "What are your current religious beliefs, if any?", widget: "textarea", required: true },
        { key: "personal_family_support", label: "Please tell us about your family and current support system.", widget: "textarea", required: true },
        { key: "personal_children_ages", label: "Do you have any children? Age(s)?", widget: "text", required: true },
        {
        ...
        { key: "personal_parenting_qualities", label: "What do you see as important qualities in parenting?", widget: "textarea", required: true },
        { key: "personal_best_quality", label: "What would your partner/best friend/parents say is your best quality?", widget: "textarea", required: true },
      ],
    },
    {
      key: "expectations",
      ...
      questions: [
        ...
        { key: "exp_communication_cadence", required: true, label: "What type of communication cadence would you prefer?", widget: "text" },
        { key: "exp_ideal_relationship", required: true, label: "Please describe your ideal surrogate relationship.", widget: "textarea" },
        { key: "exp_relationship_after_delivery", required: true, label: "What type of relationship would you like after the delivery?", widget: "text" },
        {
          key: "exp_birthday_photos", required: true,
          label: "Would you be open to providing annual birthday photos of the child to the surrogate?",
          widget: "yes_no",
        },
        { key: "exp_know_gender", required: true, label: "Will you want to know the gender of the baby?", widget: "yes_no" },
        { key: "exp_attend_obgyn", required: true, label: "Will you want to attend OBGYN appointments?", widget: "yes_no" },
        {
          key: "exp_termination", required: true,
          label: "What are your thoughts on termination? Under what circumstances would you consider a termination?",
          widget: "textarea",
        },
        {
          key: "exp_reduction", required: true,
          label: "What are your thoughts on reduction? Under what circumstances would you consider a reduction?",
          widget: "textarea",
        },
        { key: "exp_amniocentesis", required: true, label: "What are your thoughts on amniocentesis?", widget: "textarea" },
        { key: "exp_covid_vaccine", required: true, label: "Will you want your surrogate to get the COVID-19 Vaccination?", widget: "yes_no" },
        { key: "exp_flu_shot", required: true, label: "Will you want your surrogate to get the flu shot?", widget: "yes_no" },
        { key: "exp_acupuncture", required: true, label: "What are your thoughts on acupuncture?", widget: "textarea" },
        { key: "exp_pregnancy_massage", required: true, label: "What are your thoughts on pregnancy massages?", widget: "textarea" },
        {
          key: "exp_special_restrictions", required: true,
    ...
    },
    {
      ...
      questions: [
        ...
        { key: "del_tissue", required: true, label: "Do you want to bank the tissue?", widget: "yes_no" },
        {
          key: "del_cord_clamping", required: true,
    ...
    },
    {
      ...
      questions: [
        // Per-parent ID block
        { key: "priv_id_document_title", required: true, label: "Identification Document Title", widget: "text", perParent: true, excludeFromSurrogatePdf: true },
        ...
        {
          key: "priv_cps_explain", required: true,
          label: "If yes, please explain",
          widget: "textarea",
          conditionalOnKey: "priv_cps",
          conditionalTriggerValue: "yes",
        },
        { key: "priv_felony", required: true, label: "Have you/your partner ever been convicted of a felony?", widget: "yes_no" },
        {
          key: "priv_felony_explain", required: true,
          label: "If yes, please explain",
          widget: "textarea",
          conditionalOnKey: "priv_felony",
          conditionalTriggerValue: "yes",
        },
        { key: "priv_litigation", required: true, label: "Are you/your partner currently involved in any legal litigation?", widget: "yes_no" },
        {
          key: "priv_litigation_explain", required: true,
          label: "If yes, please explain",
          widget: "textarea",
          conditionalOnKey: "priv_litigation",
          conditionalTriggerValue: "yes",
        },
        { key: "priv_healthy", required: true, label: "Are you/your partner physically healthy?", widget: "yes_no" },
        {
          key: "priv_healthy_explain", required: true,
          label: "If no, please explain",
          widget: "textarea",
          conditionalOnKey: "priv_healthy",
          conditionalTriggerValue: "no",
        },
        { key: "priv_psychiatrist", required: true, label: "Have you/your partner ever been under the care of a psychiatrist?", widget: "yes_no" },
        {
          key: "priv_psychiatrist_explain", required: true,
          label: "If yes, please explain",
          widget: "textarea",
          conditionalOnKey: "priv_psychiatrist",
          conditionalTriggerValue: "yes",
        },
        { key: "priv_surgeries", required: true, label: "Have you/your partner ever undergone any major surgeries?", widget: "yes_no" },
        {
          key: "priv_surgeries_explain", required: true,
          label: "If yes, please explain",
          widget: "textarea",
          conditionalOnKey: "priv_surgeries",
          conditionalTriggerValue: "yes",
        },
        { key: "priv_will", required: true, label: "Do you have a Will that addresses the disposition of embryos and unborn child(ren)?", widget: "yes_no" },
      ],
    },
    {
      key: "acknowledgment",
      ...
      if (!section) {
        section = await prisma.ipFormSection.create({
          data: {
            ...
            descriptionIvf: def.descriptionIvf || null,
            sortOrder: (s + 1) * 10,
