...
export const BRAND_DEFAULTS: BrandSettings = {
  ...
  secondaryColor: "#F3EBE1",
  accentColor: "#8F51A3",
  successColor: "#10B981",
  warningColor: "#f59e0b",
  errorColor: "#ef4444",
  // The live brand uses the platform's own face; mirrors the SiteSettings row.
  headingFont: '-apple-system, BlinkMacSystemFont, "SF Pro Text", "Helvetica Neue", sans-serif',
